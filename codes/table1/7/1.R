...
t=parSapply(cl,1:100,function(X){
  ...
  p.noise.x=0.1; p.noise.A=seq(0.1,0.9,length=9);K=7
  p=1000; n=40; 
  m=rmultinom(p, size = 1, prob = rep(1/K, K))
  l=apply(m,2,label); para1=list(-0.5,0.6); para2=list(2,0.6); para3=list(4,0.8)
  para4=list(1, 0.6); para5=list(3, 0.6); para6=list(5,0.6); para7=list(6,0.6)
  para=list(para1, para2, para3, para4, para5, para6,para7)
